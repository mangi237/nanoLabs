  ...
  class YeboVerifyService {
    ...
    async verifyLabFacility(params: {
      ...
      try {
        ...
        if (response && response.ok) {
          ...
          return {
            ...
            issuer: 'nanoLabs Diagnostic Network & YeboVerify',
            timestamp,
      ...
      return {
        ...
        status: 'APPROVED',
        holderName: params.labName,
        documentNumber: params.licenseNumber || params.taxIdOrNiu || 'NANOLABS-ACC-2026',
        issuer: 'nanoLabs & YeboVerify Medical Identity Network',
        timestamp,
