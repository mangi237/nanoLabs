// services/authService.ts - COMPLETE FIXED VERSION
import { 
    collection, 
    query, 
    where, 
  ...
  export const authService = {
    async verifyAccessCode(code: string, labId: string): Promise<AuthResult> {
      try {
        console.log('🔍 Verifying code:', code, 'for lab:', labId);
  
        // ✅ SUPER ADMIN - Hardcoded, no Firebase needed
        ...
        // ✅ CORRECT PATH: labs/{labId}/staff
        console.log('🔍 Checking staff in: labs/', labId, '/staff');
        ...
        // ✅ CORRECT PATH: labs/{labId}/patients
        console.log('🔍 Checking patients in: labs/', labId, '/patients');
