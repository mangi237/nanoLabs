// High-speed, offline-resilient French/English DOM and String Translator for nanoLabs LIMS
...
export const MEDICAL_AND_UI_TRANSLATIONS: Record<string, string> = {
  ...
  "Refresh Network Data": "Actualiser les Données",
  "Registered Labs": "Laboratoires Enregistrés",
  "Network Patients": "Patients du Réseau",
  "Confirmed Tests": "Analyses Confirmées",
  "Confirmed Royalty": "Redevance Confirmée",
  "Active Laboratories": "Laboratoires Actifs",
  "Pending Approval": "En Attente d'Approbation",
  "Plan Requests": "Demandes de Forfait",
  "Search facility or location...": "Rechercher un établissement ou lieu...",
  "Approve & Activate Facility": "Approuver et Activer le Laboratoire",
  "Approve Plan Switch": "Approuver le Changement de Forfait",
  ...
  "Generate AI Executive Report": "Générer Rapport Exécutif IA",
  "Platform Royalty Balance": "Solde Redevance Plateforme",
  "Monthly SaaS Subscription License": "Licence d'Abonnement Mensuel SaaS",
  "Days Remaining": "Jours Restants",
  "Billing Cycle": "Cycle de Facturation",
  "Subscription Expired": "Abonnement Expiré",
  "Recharge Required": "Recharge Nécessaire",
  "Small Hospital Tier": "Formule Petit Hôpital",
  "Medium Enterprise Tier": "Formule Moyenne Entreprise",
  "Large Enterprise Tier": "Formule Grande Entreprise",
  ...
  "Receptionist Desk": "Bureau d'Accueil",
  "Receptionist": "Réceptionniste",
  "Authorized Cashier": "Caissier Autorisé",
  "Cashier": "Caisse",
  "Specimen Collector / Analyzer": "Préleveur / Analyste",
  "Phlebotomist": "Préleveur / Phlébotomiste",
  "Phlebotomist / Analyzer": "Préleveur / Analyste",
  "Lab Technologist": "Technicien de Laboratoire",
  "Lead Technologist": "Biologiste / Technicien Chef",
  "Biochemist": "Biochimiste",
  "SuperAdmin": "SuperAdmin",
  "Admin": "Administrateur",
  "Staff Hub": "Espace Personnel",
  "Patient": "Patient",
  "Role View:": "Vue du Rôle :",

  // Actions & Buttons
  "Print Report": "Imprimer le Rapport",
  "Download PDF Report": "Télécharger Rapport PDF",
  "Download PDF Certificate": "Télécharger Certificat PDF",
  "Request Virtual Result Online": "Demander Résultat en Ligne",
  ...
  "Delete": "Supprimer",
  "Submit": "Soumettre",
  "Register Patient": "Enregistrer Patient",
  ...
  "Category": "Catégorie",
  "Quantity": "Quantité",
  "Reorder Threshold Level": "Seuil de Réapprovisionnement",
  "Supplier Vendor": "Fournisseur",
  "Confirm Deletion": "Confirmer la Suppression",
  "Are you sure you want to delete this inventory item?": "Êtes-vous sûr de vouloir supprimer cet article ?",
...
Object.entries(MEDICAL_AND_UI_TRANSLATIONS).forEach(([en, fr]) => {
...
// Scan and translate the entire DOM tree
export const translateDOM = (targetLang: string) => {
  ...
  const walker = document.createTreeWalker(
    ...
    NodeFilter.SHOW_TEXT,
    {
      acceptNode: (node) => {
        ...
        // Protect dynamic user/clinical data from language translation
        if (
