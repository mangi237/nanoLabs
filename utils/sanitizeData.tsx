 ...
 */
export function cleanFirestoreData<T extends Record<string, any> | any[]>(obj: T): T {
  ...
  if (Array.isArray(obj)) {
    return obj
      ...
      .map(item => (item !== null && typeof item === 'object' && !(item instanceof Date) ? cleanFirestoreData(item) : item)) as any;
  }
