...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'invalid_credentials': 'Invalid access code or laboratory configuration.',
    'please_enter_code': 'Please enter your authorization access code.',
    'please_select_lab': 'Please select a laboratory facility.',
    ...
    'slide_founder_desc': 'Engineered by 16-year-old visionary Mangi Lerine Laslie Jr, nanoLabs eliminates administrative friction in diagnostic medicine.',
    ...
    'slide_security_desc': 'Strict Role-Based Access Control (RBAC) ensures financial staff never see clinical test data.',
    ...
    'founder_bio_full': 'Engineered from the ground up by 16-year-old visionary Mangi Lerine Laslie Jr, nanoLabs was created to eliminate administrative friction in diagnostic medicine.',
    'guarantees_title': 'Enhanced Security & Architecture Guarantees',
    'zk_title': 'Zero-Knowledge Staff Governance',
    'zk_desc': 'Administrators assign job roles only. Employees receive cryptographically hashed OTPs and set permanent private passwords.',
    ...
    'ai_desc': 'Privacy-preserving AI summarization of facility throughput, stock reorder forecasting, and multi-department operational audits.',
  ...
  fr: {
    ...
    'invalid_credentials': 'Code d\'accès ou configuration de laboratoire invalide.',
    'please_enter_code': 'Veuillez entrer votre code d\'accès d\'autorisation.',
    'please_select_lab': 'Veuillez sélectionner un laboratoire.',
    ...
    'slide_mission_desc': 'nanoLabs assure l\'orchestration diagnostique de haute précision avec livrets numériques unifiés.',
    ...
    'slide_founder_desc': 'Conçu par le visionnaire de 16 ans Mangi Lerine Laslie Jr, nanoLabs élimine les lourdeurs administratives en biologie médicale.',
    ...
    'slide_security_desc': 'Le contrôle d\'accès strict par rôle (RBAC) garantit que le personnel financier n\'accède jamais aux analyses cliniques.',
    ...
    'founder_bio_full': 'Développé de A à Z par le jeune visionnaire de 16 ans Mangi Lerine Laslie Jr, nanoLabs a été créé pour éliminer les lenteurs administratives dans le diagnostic médical.',
    'guarantees_title': 'Garanties d\'Architecture & Sécurité Renforcées',
    'zk_title': 'Gouvernance du Personnel Zéro-Connaissance',
    'zk_desc': 'Les administrateurs attribuent uniquement les rôles. Les employés reçoivent un code OTP haché et définissent un mot de passe permanent privé.',
    ...
    'ai_desc': 'Synthèse par IA préservant la vie privée sur le débit du laboratoire, la prévision des stocks de réactifs et l\'audit opérationnel multi-départements.',
