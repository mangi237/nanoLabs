            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-lg space-y-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-5">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <button
                    onClick={() => {
                      setSelectedTestIndexForPdf(null);
                      setShowPdfModal(true);
                    }}
                    className="px-3.5 py-2 bg-purple-50 hover:bg-purple-100 text-purple-800 border border-purple-200 font-bold text-xs rounded-xl flex items-center gap-1.5 transition-all cursor-pointer"
                    title="Print consolidated batch report for all tests"
                  >
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            <button
                              type="button"
                              onClick={() => {
                                setSelectedTestIndexForPdf(tIdx);
                                setShowPdfModal(true);
                              }}
                              className="px-2.5 py-1 bg-white hover:bg-purple-50 text-purple-700 border border-purple-200 hover:border-purple-300 font-bold text-[11px] rounded-lg flex items-center gap-1.5 shadow-2xs transition-all cursor-pointer"
                              title={`Print single test report for ${test.testName}`}
                            >
                              <Printer className="w-3.5 h-3.5 text-purple-600" />
                              <span>Print Single Test</span>
                            </button>
