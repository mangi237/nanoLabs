...
export const MASTER_TESTS_CATALOG: MasterTestItem[] = [
  ...
  },
  {
    ...
    subParameters: [
      { id: 'afb_smear1', name: 'Smear 1 (Early Morning Sputum)', unit: '', refRangeMale: 'Negative (No AFB seen in 100 fields)', refRangeFemale: 'Negative (No AFB seen in 100 fields)', refRangeChild: 'Negative (No AFB seen in 100 fields)' },
      { id: 'afb_smear2', name: 'Smear 2 (Spot Sputum)', unit: '', refRangeMale: 'Negative (No AFB seen in 100 fields)', refRangeFemale: 'Negative (No AFB seen in 100 fields)', refRangeChild: 'Negative (No AFB seen in 100 fields)' },
      { id: 'afb_grade', name: 'Microscopy Grade / Diagnostic Impression', unit: '', refRangeMale: 'Negative / Scanty / 1+ / 2+ / 3+', refRangeFemale: 'Negative / Scanty / 1+ / 2+ / 3+', refRangeChild: 'Negative / Scanty / 1+ / 2+ / 3+' }
    ]
  },
  {
    id: 'mb-04',
  ...
  },
  {
    ...
    subParameters: [
      { id: 'consistency', name: 'Consistency', unit: '', refRangeMale: 'Formed / Soft', refRangeFemale: 'Formed / Soft', refRangeChild: 'Formed / Soft' },
      { id: 'color', name: 'Color', unit: '', refRangeMale: 'Brownish', refRangeFemale: 'Brownish', refRangeChild: 'Brownish / Yellow' },
      { id: 'mucus_blood', name: 'Mucus / Occult Blood', unit: '', refRangeMale: 'Negative (Absent)', refRangeFemale: 'Negative (Absent)', refRangeChild: 'Negative (Absent)' },
      { id: 'protozoa_cysts', name: 'Protozoan Cysts (E. histolytica / Giardia)', unit: '', refRangeMale: 'None seen', refRangeFemale: 'None seen', refRangeChild: 'None seen' },
      { id: 'trophozoites', name: 'Motile Trophozoites', unit: '', refRangeMale: 'None seen', refRangeFemale: 'None seen', refRangeChild: 'None seen' },
      { id: 'helminth_ova', name: 'Helminth Eggs / Larvae', unit: '', refRangeMale: 'None seen', refRangeFemale: 'None seen', refRangeChild: 'None seen' },
      { id: 'stool_pus_cells', name: 'Pus Cells / Leucocytes', unit: '/HPF', refRangeMale: '0 - 2', refRangeFemale: '0 - 2', refRangeChild: '0 - 2', maleMin: 0, maleMax: 2, femaleMin: 0, femaleMax: 2, childMin: 0, childMax: 2 },
      { id: 'stool_rbc', name: 'Red Blood Cells', unit: '/HPF', refRangeMale: '0 - 1', refRangeFemale: '0 - 1', refRangeChild: '0 - 1', maleMin: 0, maleMax: 1, femaleMin: 0, femaleMax: 1, childMin: 0, childMax: 1 }
    ]
  },
  ...
  },
  {
    ...
    subParameters: [
      { id: 'typhi_o', name: "Salmonella Typhi 'O' Antigen Titer", unit: 'Titer', refRangeMale: '< 1:80', refRangeFemale: '< 1:80', refRangeChild: '< 1:80' },
      { id: 'typhi_h', name: "Salmonella Typhi 'H' Antigen Titer", unit: 'Titer', refRangeMale: '< 1:80', refRangeFemale: '< 1:80', refRangeChild: '< 1:80' },
      { id: 'paratyphi_ao', name: "Salmonella Paratyphi 'AO' Antigen Titer", unit: 'Titer', refRangeMale: '< 1:80', refRangeFemale: '< 1:80', refRangeChild: '< 1:80' },
      { id: 'paratyphi_bo', name: "Salmonella Paratyphi 'BO' Antigen Titer", unit: 'Titer', refRangeMale: '< 1:80', refRangeFemale: '< 1:80', refRangeChild: '< 1:80' },
      { id: 'widal_conclusion', name: 'Clinical Serological Interpretation', unit: '', refRangeMale: 'Negative (Titer < 1:80) / Significant Infection (>= 1:160)', refRangeFemale: 'Negative (Titer < 1:80) / Significant Infection (>= 1:160)', refRangeChild: 'Negative (Titer < 1:80) / Significant Infection (>= 1:160)' }
    ]
  },
  {
    id: 'sero-06',
