...
export const TractionSection: React.FC = () => {
  return (
    <section id="traction" className="py-24 bg-[#041C18] relative overflow-hidden border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          {siteConfig.milestones.map((milestone, idx) => (
            <div
              key={idx}
              className="p-6 rounded-3xl bg-[#0A2C27]/60 border border-white/10 hover:border-[#2DD4BF]/40 transition-all duration-300 hover:shadow-2xl flex flex-col justify-between space-y-4 relative"
            >
              <div className="space-y-3">
                ...
                {milestone.date && (
                  <div className="text-xs font-semibold text-[#2DD4BF]">
                    {milestone.date}
                  </div>
                )}
