    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-nl-ink/50 backdrop-blur-md overflow-y-auto"
        >
          <motion.div
            ...
            className="bg-white border border-slate-200 rounded-3xl max-w-2xl w-full p-6 sm:p-8 shadow-2xl text-nl-ink space-y-6 relative max-h-[85vh] flex flex-col"
          >
            <div className="flex items-center justify-between pb-4 border-b border-slate-200 shrink-0">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-nl-mint border border-nl-light/40 text-nl-deep flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">Effective September 2026 · Republic of Cameroon</p>
                </div>
              </div>
              <button
                onClick={onClose}
                className="p-2 text-slate-400 hover:text-nl-ink rounded-xl hover:bg-slate-100 transition-colors cursor-pointer"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
              ...
              {type === 'privacy' ? (
                <>
                  <section className="space-y-1">
                    <h4 className="text-sm font-bold text-nl-ink">1. Diagnostic data</h4>
                  ...
                  <section className="space-y-1">
                    <h4 className="text-sm font-bold text-nl-ink">2. Insurance verification</h4>
                  ...
                  <section className="space-y-1">
                    <h4 className="text-sm font-bold text-nl-ink">3. Audit trail</h4>
                  ...
                  <section className="space-y-1">
                    <h4 className="text-sm font-bold text-nl-ink">4. Access codes</h4>
                  ...
                  <section className="space-y-1">
                    <h4 className="text-sm font-bold text-nl-ink">5. Data subject rights</h4>
                ...
                <>
                  <section className="space-y-1">
                    <h4 className="text-sm font-bold text-nl-ink">1. Platform role</h4>
                  ...
                  <section className="space-y-1">
                    <h4 className="text-sm font-bold text-nl-ink">2. Money flow</h4>
                  ...
                  <section className="space-y-1">
                    <h4 className="text-sm font-bold text-nl-ink">3. Clinical authority</h4>
                  ...
                  <section className="space-y-1">
                    <h4 className="text-sm font-bold text-nl-ink">4. Availability</h4>
                  ...
                  <section className="space-y-1">
                    <h4 className="text-sm font-bold text-nl-ink">5. Governing law</h4>
            ...
            <div className="pt-4 border-t border-slate-200 flex items-center justify-between text-xs shrink-0">
              <span className="text-slate-500">nanoLabs · Douala & Yaoundé</span>
              <button
                onClick={onClose}
                className="px-5 py-2 rounded-xl bg-gradient-to-r from-nl-deep to-nl-teal text-white font-bold cursor-pointer hover:scale-[1.03] transition-transform"
              >
                I understand
              </button>
            </div>
